...
j = 0
#for i in [0,2,3,4,5,4,3,2,0,1,2,3,2,1,0,1,0]:
#for i in [0,1,1,1,8,7,6,5,4,6,5,4,3,5,4,3,2,4,3,2,1,3,2,1,1]:
for i in [0,3,5,6,7,8,8,8,7,6,5,3,2,3,4,4,3,2,0,4,2,2,2]:
    print j
    j += 1
